...
public class PWSState extends State {
    ...
    // Exit zones generated by incoming transition codomain outside this state's constraints.
    private HashSet<ExitZone> incomingTransitionOverflowExitZones = new HashSet<>();
    ...
    /** Returns transition-generated overflow exit zones (incoming codomain outside CS). */
    public HashSet<ExitZone> getIncomingTransitionOverflowExitZones() {
        return incomingTransitionOverflowExitZones;
    }

    /** Sets transition-generated overflow exit zones (incoming codomain outside CS). */
    public void setIncomingTransitionOverflowExitZones(HashSet<ExitZone> incomingTransitionOverflowExitZones) {
        this.incomingTransitionOverflowExitZones = incomingTransitionOverflowExitZones != null
                ? incomingTransitionOverflowExitZones
                : new HashSet<>();
    }
